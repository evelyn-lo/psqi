...
public class User {
    ...
    public User() {
        ...
        questions.add(4, "5.過去一個月來，您的睡眠有多少次受到下列干擾？(0:從未發生，1:每週少於一次，2:每週1~2次，3:每週3次或以上)\n 5-a. 無法在 30 分鐘入睡");
        questions.add(5, "(0:從未發生，1:每週少於一次，2:每週1~2次，3:每週3次或以上)：\n5-b. 半夜或清晨醒來");
        questions.add(6, "(0:從未發生，1:每週少於一次，2:每週1~2次，3:每週3次或以上)：\n5-c. 需要起床上廁所");
        questions.add(7, "(0:從未發生，1:每週少於一次，2:每週1~2次，3:每週3次或以上)：\n5-d. 呼吸不順暢");
        questions.add(8, "(0:從未發生，1:每週少於一次，2:每週1~2次，3:每週3次或以上)：\n5-e. 咳嗽或大聲打鼾");
        questions.add(9, "(0:從未發生，1:每週少於一次，2:每週1~2次，3:每週3次或以上)：\n5-f. 感覺很冷");
        questions.add(10, "(0:從未發生，1:每週少於一次，2:每週1~2次，3:每週3次或以上)：\n5-g. 感覺很熱");
        questions.add(11, "(0:從未發生，1:每週少於一次，2:每週1~2次，3:每週3次或以上)：\n5-h. 作惡夢");
        questions.add(12, "(0:從未發生，1:每週少於一次，2:每週1~2次，3:每週3次或以上)：\n5-i. 疼痛");
